  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="font-display font-bold text-2xl md:text-3xl text-[#0F2F1E] tracking-tight font-serif">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5">
        <div className="bg-white p-4 rounded-2xl border border-slate-200/80 shadow-xs">
          ...
          <div className="text-2xl font-bold font-display text-[#0F2F1E] mt-1 font-serif">{totalCount}</div>
        ...
        <div className="bg-white p-4 rounded-2xl border border-slate-200/80 shadow-xs">
          ...
          <div className="text-2xl font-bold font-display text-[#0F2F1E] mt-1 font-serif">{activeContractsCount}</div>
          <div className="text-[11px] text-emerald-700 font-medium mt-1 flex items-center gap-1">
        ...
        <div className="bg-white p-4 rounded-2xl border border-slate-200/80 shadow-xs">
          ...
          <div className="text-2xl font-bold font-display text-amber-900 mt-1 font-serif">{onLeaveCount}</div>
        ...
        <div className="bg-white p-4 rounded-2xl border border-slate-200/80 shadow-xs">
          ...
          <div className="text-2xl font-bold font-display text-[#0F2F1E] mt-1 font-serif">
                ...
                <div>
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex items-center gap-3">
                      ...
                      />
                      <div>
                        <h4 className="font-semibold text-slate-900 group-hover:text-emerald-900 transition flex items-center gap-1.5 font-serif">
                          {emp.first_name} {emp.last_name}
                          {emp.id === 1 && (
                            <span className="text-[9px] font-mono px-1.5 py-0.5 rounded bg-emerald-100 text-emerald-800 font-bold">
                              HERO
                ...
                <div className="pt-3 border-t border-slate-100 flex items-center justify-between text-xs">
                  {isCompliant ? (
                    ...
                    <span className="text-[11px] text-amber-700 font-medium flex items-center gap-1">
                      <AlertTriangle className="w-3.5 h-3.5 text-amber-600" /> Missing Bank/Tax
                    </span>
                  )}
